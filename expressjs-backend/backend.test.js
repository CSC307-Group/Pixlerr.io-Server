...
//   password: "Testingg",
//   pixelTime: "testTime",
//   user_email: "rmarohn@calpoly.edu",
// };
// //user-services tests
...
//       result.pixelTime === user.pixelTime
//   ).toBeTruthy();
// });

// test("add user with invalid password", async () => {
//   result = await userServices.addUser({
//     username: "test",
//     password: "small",
//     pixelTime: "testingtest",
//     user_email: "tiny@snailmail.com",
//   });
...
//   expect(
//     result[0].username === user.username && result[0].password === user.password
//   ).toBeTruthy();
// });
...
//       result[0].user_email === user.user_email
//   ).toBeTruthy();
// });
...
//   getUser = await userServices.getUsers(
//     user.username,
//     user.password,
//     user.user_email
//   );
